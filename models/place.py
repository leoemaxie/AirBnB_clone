...
class Place(BaseModel):
    ...
    Public class attributes:
        name: str -> The name of the place a user resides/stays in
        city_id: str -> Defined by [City.id]. The city_id of the state a user
        a city is located. 
        user_id: str -> Defined by [User.id]. The user id of the user searching
        for an accomodation.
        ...
        max_guest: integer -> Maximum number of guests an accomodation can take.
